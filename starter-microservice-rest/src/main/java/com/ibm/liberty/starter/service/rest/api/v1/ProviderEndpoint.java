 ...
 *******************************************************************************/
package com.ibm.liberty.starter.service.rest.api.v1;
...
public class ProviderEndpoint {
    ...
    private static final String DEPENDENCY_URL = "http://localhost:9082/rest/artifacts/net/wasdev/wlp/starters/rest";
    ...
    public Provider details(@Context UriInfo info) {
        ...
        providedDependency.setGroupId("net.wasdev.wlp.starters.rest");
        ...
        runtimeDependency.setGroupId("net.wasdev.wlp.starters.rest");
