...
public class TestApplication extends EndpointTest {
    ...
    public void testProvider() throws Exception {
        ...
        assertTrue("Description was not found.", provider.getDescription().contains("<h2>REST</h2>"));
        ...
        for (Dependency dependency : dependencies) {
            if (Dependency.Scope.PROVIDED.equals(dependency.getScope())) {
                assertTrue("groupId incorrect.", "net.wasdev.wlp.starters.rest".equals(dependency.getGroupId()));
    ...
    public void testSamples() throws Exception {
        ...
        assertEquals("At least one file expected for sample", 2, sample.getLocations().length);
    }
